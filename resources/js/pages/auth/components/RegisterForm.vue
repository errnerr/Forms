<template>
  <div>
    <!-- <form @submit.prevent="register" @keydown="form.onKeydown($event)" :readonly="true" class="mt-4">
      <!-- Name -->
      <!-- <text-input name="name" :form="form" :label="$t('name')" placeholder="Your name" :required="true" /> -->

      <!-- Email -->
      <!-- <text-input :readonly="readonly" name="email" :form="form" :label="$t('email')" :required="true" placeholder="Your email address" />
